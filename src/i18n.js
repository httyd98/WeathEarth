...
const translations = {
  it: {
    ...
    "legend.title.heatmap": "Heatmap temperatura",
    "legend.title.wind": "Velocità del vento",
    "legend.title.precipitation": "Precipitazioni",
    "legend.title.emField": "Campo elettromagnetico",
    "legend.footnote.heatmap": "Interpolazione della temperatura superficiale.",
    "legend.footnote.wind": "Velocità del vento interpolata dai dati meteorologici.",
    "legend.footnote.precipitation": "Intensità precipitazioni da radar e stazioni.",
    "legend.footnote.emField": "Intensità del campo magnetico terrestre (modello WMM2025).",
    ...
    "btn.tiltSimple":          "Asse fisso 23.4°",
  ...
  en: {
    ...
    "legend.title.heatmap": "Temperature heatmap",
    "legend.title.wind": "Wind speed",
    "legend.title.precipitation": "Precipitation",
    "legend.title.emField": "Electromagnetic field",
    "legend.footnote.heatmap": "Surface temperature interpolation.",
    "legend.footnote.wind": "Wind speed interpolated from weather data.",
    "legend.footnote.precipitation": "Precipitation intensity from radar and stations.",
    "legend.footnote.emField": "Earth magnetic field intensity (WMM2025 model).",
    ...
    "btn.tiltSimple":          "Fixed 23.4° axis",
